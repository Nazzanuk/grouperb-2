const VOTE_QUESTIONS = [
  ...
  'has good things coming their way',
  'is a good person',
  ...
  'is thinking of their next move',
  'is trying too hard to win',
  ...
  `would make a good graphic designer`,
  `uses a lot of sarcasm`,
  `has to be at every party`,
  `would make a great mix playlist`,
  `would bring you flowers when you were really ill`,
  ...
  `has no problem throwing tantrums`,
  `digs holes`,
  `talks in their sleep`,
  `is a world class karaoke singer`,
  `never loses a fight`,
  `loves to scream`,
  `is someone you'd rather be`,
  `is trying to tell you the world is not about what you want, but about what you need`,
  `knows too much and is too cynical`,
  ...
  `needs an advice from his friend`,
  `can be found waiting in the freezing rain for you`,
  ...
  `is trying to make a movie about his life`,
  `is someone who could solve the latest U.S. government crisis`,
  `is feeling something`,
  `is a smart-ass`,
  `has all the self control of a baby`,
  `would make a great action movie star`,
  `hates reality`,
  ...
  `will tell you everything and then disappear`,
