...
import { StartCharlatanVotingPayload } from 'Entities/Payloads.entity';
import { UserId } from 'Entities/UserId.entity';

import { ServerGames } from 'Server/ServerGames';

export const startCharlatanVoting = (payload: StartCharlatanVotingPayload): CharlatanGame => {
  ...
  currentRound.startedVoting = new Date().toISOString();
