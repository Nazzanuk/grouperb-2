...
import { EndBlocksRoundPayload } from 'Entities/Payloads.entity';
...
export const endBlocksRound = (payload: EndBlocksRoundPayload): BlocksGame => {
  console.log('endBlocksRound', payload);
  const game = ServerGames[payload.gameId] as BlocksGame;
  
  game.status = 'results';

  console.log('endBlocksRound', game);
  return game;
};